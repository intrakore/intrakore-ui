...
import { Heading2 as Heading2 } from 'lucide-vue-next'
import { Heading3 as Heading3 } from 'lucide-vue-next'
import { List as List } from 'lucide-vue-next'
import { ListOrdered as ListOrdered } from 'lucide-vue-next'
import { ListChecks as ListTask } from 'lucide-vue-next'
import { Code as Code } from 'lucide-vue-next'
import { Quote as Quote } from 'lucide-vue-next'
import { Image as Image } from 'lucide-vue-next'
import { Video as Video } from 'lucide-vue-next'
import { GalleryVertical as GalleryVertical } from 'lucide-vue-next'
